...
import { HomePageRoutingModule } from '../main/home-page/home-page-routing.module';
...
@NgModule({
  declarations: [CreateWorkoutComponent, UploadComponent],
  exports: [ButtonModule, IconFieldModule, CreateWorkoutComponent],
  imports: [
    CommonModule,
    ReactiveFormsModule,
    PanelModule,
